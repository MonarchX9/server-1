...
echo -e "================================="
echo -e "QR Code Link   : https://api.qrserver.com/v1/create-qr-code/?size=400x400&data=vless://$uuid@$domain:80?security=xtls&flow=xtls-rprx-direct#vless_xtls_${user}"
echo -e "================================="
